...
from StoneXMusic import Carbon, app, HEYEMOJI
from StoneXMusic.utils.decorators.language import language, languageCB
from StoneXMusic.utils.inline.playlist import (
    botplaylist_markup,
    get_playlist_markup,
    warning_markup,
)
...
async def add_playlist(client, CallbackQuery, _):
    from ChampuXMusic import YouTube
...
@app.on_callback_query(filters.regex("Stone_playlist") & ~BANNED_USERS)
@languageCB
