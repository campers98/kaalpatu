...
from StoneXMusic.utils import first_page, second_page
from StoneXMusic.utils.database import get_lang
from StoneXMusic.utils.decorators.language import LanguageStart, languageCB
from StoneXMusic.utils.inline.help import help_back_markup, private_help_panel
    ...
    if cb == "hb9":
        if CallbackQuery.from_user.id not in SUDOERS:
            return await CallbackQuery.answer(
                "😎𝗣𝗔𝗛𝗟𝗘 ꜱᴛᴏɴᴇ𓆪 𝗞𝗢 𝗣𝗔𝗣𝗔 𝗕𝗢𝗟 𝗝𝗔𝗞𝗘 😆😆", show_alert=True
            )
        else:
...
@Client.on_callback_query(filters.regex("fenu") & ~BANNED_USERS)
@languageCB
