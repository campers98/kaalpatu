...
from StoneXMusic.utils.database import add_served_chat_clone
from StoneXMusic.utils.decorators.language import languageCB
from StoneXMusic.utils.decorators.play import CPlayWrapper
...
@Client.on_callback_query(filters.regex("ChampuAdmin") & ~BANNED_USERS)
async def Champu_check(client: Client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@Client.on_callback_query(filters.regex("ChampuPlaylists") & ~BANNED_USERS)
@languageCB
...
import config
from StoneXMusic import Carbon, YouTube
...
from StoneXMusic.utils.inline import aq_markup, close_markup, stream_markup2
